...
Overall, the work presents an **integrated architecture** combining AI, SIEM, threat intelligence, and SOAR to improve detection accuracy, response speed, and scalability in modern cybersecurity operations.
